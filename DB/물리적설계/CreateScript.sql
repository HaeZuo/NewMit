...
CREATE TABLE TB_FILE_INFO (
    FILE_INFO_NO INT(10) COMMENT '파일 정보 넘버' NOT NULL PRIMARY KEY ,
    FILE_INFO_ORG_NM VARCHAR(150) COMMENT '파일 정보 오리지널 파일명' NOT NULL,
    FILE_INFO_CUR_NM VARCHAR(150) COMMENT '파일 정보 현재 파일명' NOT NULL,
    FILE_INFO_SIZE VARCHAR(150) COMMENT '파일 정보 파일 크기' NOT NULL,
